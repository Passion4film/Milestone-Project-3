...
var ingredientCount = 1;
    document.getElementById('addIngredient').addEventListener('click', function(){
        ...
        const newInput = '<div class="input-field col s12"> <i class="fas fa-balance-scale prefix deep-purple-text text-darken-3 text-shadow"></i> <textarea id="'+ labelText + '" name="ingredients_measurements" minlength="5" maxlength="300" class="materialize-textarea validate" required="" spellcheck="false"></textarea> <label for="'+ labelText + '">'+ labelText + '</label><i class="fas fa-trash-alt deep-purple-text text-darken-3 text-shadow removeInput" id="'+ removeId + '"></i></div>';
...
var stepCount = 1;
    document.getElementById('addStep').addEventListener('click', function(){
        ...
        const newInput = '<div class="input-field col s12"> <i class="fas fa-clipboard-list prefix deep-purple-text text-darken-3 text-shadow"></i> <textarea id="'+ labelText + '" name="ingredients_measurements" minlength="5" maxlength="300" class="materialize-textarea validate" required="" spellcheck="false"></textarea> <label for="'+ labelText + '">'+ labelText + '</label><i class="fas fa-trash-alt deep-purple-text text-darken-3 text-shadow removeInput" id="'+ removeId + '"></i></div>';
        newDiv = document.createElement("div")
        newDiv.id = nextId;
